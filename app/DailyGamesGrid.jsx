...
const GAMES = [
  ...
  { key: 'frame', href: '/frame', name: 'Frame', tag: 'The daily frame sudoku', img: '/games/btn-frame.png' },
  { key: 'rim', href: '/rim', name: 'Rim', tag: 'The daily outside sudoku', img: '/games/btn-rim.png' },
  ...
  { key: 'snug', href: '/snug', name: 'Snug', tag: 'Fit the pieces, one way only', img: '/games/btn-snug.png' },
  ...
  { key: 'crib', href: '/crib', name: 'Crib', tag: 'Six cards, throw two', img: '/games/btn-crib.png' },
