...
export default function QuotesClient({ puzzles = [], questionsByNum = {}, forceNum = null }) {
  ...
  const STAGE_ACC = { '--stg-acc-dk': gameColor('quotes'), '--stg-acc-lt': gameColorLight('quotes'), '--stg-onramp-lt': gameOnrampLight('quotes'), '--stg-acc-ink-lt': gameAccentInkLight('quotes') };
