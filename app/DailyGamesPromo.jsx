...
export const DAILY_GAMES = [
  ...
  { key: 'crib', href: '/crib', name: 'Crib', tag: 'six cards, throw two', store: 'sot_crib_day', accent: '#a16207', bg: '#fbf3dd', border: 'rgba(161,98,7,0.4)' },
  ...
  { key: 'yose', href: '/yose', name: 'Yose', tag: 'the last points on the board', store: 'sot_yose_day', accent: '#44403c', bg: '#efedeb', border: 'rgba(68,64,60,0.4)' },
