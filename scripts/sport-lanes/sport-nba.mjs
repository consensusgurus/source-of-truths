export const LANE_DAYS = [
  // day 1
  [
    { c: 'NBA', t: 1, q: 'What is the name of the boundary line running behind each basket?', a: 'The baseline', d: ['The sideline', 'The wing', 'The perimeter'] },
    { c: 'NBA', t: 2, q: 'Who is credited with inventing the game of basketball at a Massachusetts YMCA school in 1891?', a: 'James Naismith', d: ['Amos Alonzo Stagg', 'Walter Camp', 'Luther Gulick'] },
    { c: 'NBA', t: 3, q: 'In which Massachusetts city does the Naismith Memorial Basketball Hall of Fame stand?', a: 'Springfield', d: ['Worcester', 'Lowell', 'Holyoke'] },
    { c: 'NBA', t: 4, q: 'How many championships in a row did the Boston Celtics win from 1959 through 1966?', a: 'Eight', d: ['Six', 'Seven', 'Nine'] },
    { c: 'NBA', t: 5, q: 'Who coached the Minneapolis Lakers to their five championships between 1949 and 1954?', a: 'John Kundla', d: ['Joe Lapchick', 'Red Holzman', 'Les Harrison'] },
  ],
  // day 2
  [
    { c: 'NBA', t: 1, q: 'What is the name of the top professional basketball league for women in the United States?', a: 'The WNBA', d: ['The ABL', 'The NWBL', 'The USBL'] },
    { c: 'NBA', t: 2, q: 'Hakeem Olajuwon grew up in which African country before moving to the United States for college?', a: 'Nigeria', d: ['Cameroon', 'Ghana', 'Senegal'] },
    { c: 'NBA', t: 3, q: 'Patrick Ewing led which university to the 1984 NCAA championship?', a: 'Georgetown', d: ['Villanova', 'Syracuse', "St. John's"] },
    { c: 'NBA', t: 4, q: 'Which college player was carried on the 1992 United States Olympic roster alongside the professionals?', a: 'Christian Laettner', d: ['Alonzo Mourning', 'Grant Hill', 'Shaquille O\'Neal'] },
    { c: 'NBA', t: 5, q: 'The franchise later renamed the Washington Wizards entered the league in 1961 under which name?', a: 'The Chicago Packers', d: ['The Cincinnati Royals', 'The Syracuse Nationals', 'The Fort Wayne Pistons'] },
  ],
  // day 3
  [
  ...
  [
    ...
    { c: 'NBA', t: 5, q: 'Before moving to Auburn Hills in 1988, the Pistons played in a domed stadium in which Michigan city?', a: 'Pontiac', d: ['Flint', 'Ann Arbor', 'Lansing'] },
  ],
  // day 5
  [
    { c: 'NBA', t: 1, q: 'What is the annual event at which NBA teams select incoming players called?', a: 'The draft', d: ['The combine', 'The auction', 'The waiver wire'] },
    { c: 'NBA', t: 2, q: 'Which team took Shaquille O\'Neal with the first overall pick in 1992?', a: 'Orlando Magic', d: ['Charlotte Hornets', 'Dallas Mavericks', 'Minnesota Timberwolves'] },
    { c: 'NBA', t: 3, q: 'Which player went first overall in the 1979 draft after leading Michigan State to the national title?', a: 'Magic Johnson', d: ['Sidney Moncrief', 'David Greenwood', 'Bill Cartwright'] },
    { c: 'NBA', t: 4, q: 'Before the lottery existed, how did the NBA settle which of its two worst teams picked first?', a: 'A coin flip', d: ['A vote of the owners', 'A one game playoff', 'Reverse order of the standings'] },
    { c: 'NBA', t: 5, q: 'Which team won the very first NBA draft lottery, held in 1985?', a: 'New York Knicks', d: ['Indiana Pacers', 'Golden State Warriors', 'Los Angeles Clippers'] },
  ],
  // day 6
  [
    ...
    { c: 'NBA', t: 5, q: 'Which club won the very first ABA championship, in 1968?', a: 'The Pittsburgh Pipers', d: ['The New Orleans Buccaneers', 'The Oakland Oaks', 'The Dallas Chaparrals'] },
  ],
  // day 7
  [
    ...
    { c: 'NBA', t: 5, q: 'Which Celtic was named Finals Most Valuable Player in 1981?', a: 'Cedric Maxwell', d: ['Larry Bird', 'Robert Parish', 'Nate Archibald'] },
  ],
  // day 8
  [
    { c: 'NBA', t: 1, q: 'In which decade did the Chicago Bulls win six championships?', a: 'The 1990s', d: ['The 1970s', 'The 1980s', 'The 2000s'] },
    { c: 'NBA', t: 2, q: 'Michael Jordan was widely known by which regal sounding nickname?', a: 'His Airness', d: ['The Mailman', 'The Glide', 'The Answer'] },
    { c: 'NBA', t: 3, q: 'Which team did the Bulls beat in the 1996 NBA Finals?', a: 'Seattle SuperSonics', d: ['Utah Jazz', 'Orlando Magic', 'Portland Trail Blazers'] },
    { c: 'NBA', t: 4, q: 'Which Croatian forward won the NBA Sixth Man of the Year award in 1996 with Chicago?', a: 'Toni Kukoc', d: ['Dino Radja', 'Vlade Divac', 'Drazen Petrovic'] },
    { c: 'NBA', t: 5, q: 'How many regular season games did Michael Jordan play in the 1994 to 1995 season after returning in March?', a: '17', d: ['12', '22', '29'] },
  ],
  // day 9
  [
  ...
  [
    ...
    { c: 'NBA', t: 5, q: 'Oscar Robertson was traded to Milwaukee in 1970 from which franchise?', a: 'The Cincinnati Royals', d: ['The Baltimore Bullets', 'The San Diego Rockets', 'The St. Louis Hawks'] },
  ],
  // day 11
  [
    ...
    { c: 'NBA', t: 5, q: 'Who won the NBA Coach of the Year award in its first season, 1963?', a: 'Harry Gallatin', d: ['Red Auerbach', 'Alex Hannum', 'Fred Schaus'] },
  ],
  // day 12
  [
    ...
    { c: 'NBA', t: 5, q: 'The Rookie of the Year trophy is named for which pioneering owner and coach?', a: 'Eddie Gottlieb', d: ['Danny Biasone', 'Ned Irish', 'Walter Brown'] },
  ],
  // day 13
  [
    { c: 'NBA', t: 1, q: 'What is the undefended shot awarded after a foul, taken from a marked line, called?', a: 'A free throw', d: ['A layup', 'A jump shot', 'A tip in'] },
    { c: 'NBA', t: 2, q: 'Which Celtics playmaker of the 1950s was nicknamed the Houdini of the Hardwood?', a: 'Bob Cousy', d: ['Bill Sharman', 'Sam Jones', 'Frank Ramsey'] },
    { c: 'NBA', t: 3, q: 'Wilt Chamberlain played his college basketball at which university?', a: 'Kansas', d: ['Kentucky', 'Indiana', 'Ohio State'] },
    { c: 'NBA', t: 4, q: 'In which season did the Philadelphia 76ers win 68 regular season games and the championship behind Wilt Chamberlain?', a: '1966 to 1967', d: ['1964 to 1965', '1968 to 1969', '1962 to 1963'] },
    { c: 'NBA', t: 5, q: 'Which Celtic made the famous late steal that decided Game 7 of the 1965 Eastern Division finals?', a: 'John Havlicek', d: ['Tom Heinsohn', 'Satch Sanders', 'Sam Jones'] },
  ],
  // day 14
  [
    ...
    { c: 'NBA', t: 5, q: 'Which small college did Scottie Pippen attend before the 1987 draft?', a: 'Central Arkansas', d: ['Arkansas State', 'Henderson State', 'Southern Illinois'] },
  ],
  // day 15
  [
    ...
    { c: 'NBA', t: 5, q: 'Before settling in Oakland in 1971, the Warriors franchise had played in which two cities?', a: 'Philadelphia and San Francisco', d: ['Philadelphia and Los Angeles', 'Rochester and San Francisco', 'Syracuse and San Diego'] },
  ],
  // day 16
  [
  ...
  // day 17
  [
    { c: 'NBA', t: 1, q: 'In which month is the NBA All-Star Game traditionally played?', a: 'February', d: ['November', 'April', 'August'] },
    { c: 'NBA', t: 2, q: 'Which All-Star Weekend event has shooters working through timed racks of balls?', a: 'The Three-Point Contest', d: ['The Skills Challenge', 'The Slam Dunk Contest', 'The Rising Stars Challenge'] },
    { c: 'NBA', t: 3, q: 'Which city hosted the first NBA All-Star Game, in 1951?', a: 'Boston', d: ['New York', 'Philadelphia', 'Chicago'] },
    { c: 'NBA', t: 4, q: 'Who won the Slam Dunk Contest staged on his own home floor in Chicago?', a: 'Michael Jordan', d: ['Dominique Wilkins', 'Clyde Drexler', 'Otis Smith'] },
    { c: 'NBA', t: 5, q: 'Which Bulls guard won three straight Three-Point Contests from 1990 through 1992?', a: 'Craig Hodges', d: ['B.J. Armstrong', 'Steve Kerr', 'John Paxson'] },
  ],
  // day 18
  [
  ...
  [
    ...
    { c: 'NBA', t: 5, q: 'Which guard led the NBA in both scoring and assists in the 1972 to 1973 season?', a: 'Nate Archibald', d: ['Pete Maravich', 'Walt Frazier', 'Jerry West'] },
  ],
  // day 20
  [
  ...
  // day 21
  [
    { c: 'NBA', t: 1, q: 'The Golden State Warriors play in which state?', a: 'California', d: ['Oregon', 'Nevada', 'Washington'] },
    { c: 'NBA', t: 2, q: 'Which Bay Area city did the Warriors call home from 1971 to 2019?', a: 'Oakland', d: ['San Jose', 'Berkeley', 'Fremont'] },
    { c: 'NBA', t: 3, q: 'Which player became the first unanimous Most Valuable Player in league history, in 2016?', a: 'Stephen Curry', d: ['LeBron James', 'Kevin Durant', 'Russell Westbrook'] },
    { c: 'NBA', t: 4, q: 'In what year did the Philadelphia Warriors win the first BAA championship?', a: '1947', d: ['1946', '1949', '1950'] },
    { c: 'NBA', t: 5, q: 'Which coach led Golden State to the 1975 championship?', a: 'Al Attles', d: ['Alex Hannum', 'Bill Sharman', 'Butch van Breda Kolff'] },
  ],
  // day 22
  [
    ...
    { c: 'NBA', t: 5, q: 'Which player signed the first NBA contract worth more than 100 million dollars, in 1997?', a: 'Kevin Garnett', d: ['Shawn Kemp', 'Juwan Howard', 'Alonzo Mourning'] },
  ],
  // day 23
  [
  ...
  [
    ...
    { c: 'NBA', t: 5, q: 'Which forward did Indiana draft 15th overall in 2011 before trading him to San Antonio for George Hill?', a: 'Kawhi Leonard', d: ['Paul George', 'Danny Green', 'Jimmy Butler'] },
  ],
  // day 25
  [
  ...
  // day 28
  [
    { c: 'NBA', t: 1, q: 'The Detroit Pistons play in which state?', a: 'Michigan', d: ['Ohio', 'Illinois', 'Indiana'] },
    { c: 'NBA', t: 2, q: 'Which Pistons point guard, nicknamed Zeke, captained the two title teams?', a: 'Isiah Thomas', d: ['Joe Dumars', 'Vinnie Johnson', 'John Salley'] },
    { c: 'NBA', t: 3, q: 'In which year did the Pistons sweep the Lakers for their first championship?', a: '1989', d: ['1987', '1988', '1990'] },
    { c: 'NBA', t: 4, q: 'What name was given to the Pistons defensive plan for containing Chicago in the late 1980s?', a: 'The Jordan Rules', d: ['The Motor City Wall', 'The Palace Press', 'The Auburn Hills Trap'] },
    { c: 'NBA', t: 5, q: 'Which Pistons reserve was nicknamed The Microwave for how fast he heated up?', a: 'Vinnie Johnson', d: ['Joe Dumars', 'Mark Aguirre', 'James Edwards'] },
  ],
  // day 29
  [
    ...
    { c: 'NBA', t: 5, q: 'Which Lakers owner, who bought the club in 1979, was elected to the Hall of Fame in 2010?', a: 'Jerry Buss', d: ['Jack Kent Cooke', 'Abe Pollin', 'Bill Davidson'] },
  ],
  // day 30
  [
  ...
  [
    ...
    { c: 'NBA', t: 5, q: 'Who went first overall in the 2000 draft, a class often called one of the weakest?', a: 'Kenyon Martin', d: ['Stromile Swift', 'Darius Miles', 'Marcus Fizer'] },
  ],
  // day 32
  [
    ...
    { c: 'NBA', t: 5, q: 'Which Houston reserve hit the Kiss of Death three pointer in Game 7 against Phoenix in 1995?', a: 'Mario Elie', d: ['Robert Horry', 'Kenny Smith', 'Sam Cassell'] },
  ],
  // day 33
  [
    ...
    { c: 'NBA', t: 5, q: 'Who was named Most Valuable Player of the 1973 NBA Finals?', a: 'Willis Reed', d: ['Walt Frazier', 'Dave DeBusschere', 'Earl Monroe'] },
  ],
  // day 34
  [
  ...
  [
    ...
    { c: 'NBA', t: 5, q: 'Which guard did Philadelphia receive from Phoenix in the 1992 Charles Barkley trade?', a: 'Jeff Hornacek', d: ['Dan Majerle', 'Kevin Johnson', 'Danny Ainge'] },
  ],
  // day 38
  [
    ...
    { c: 'NBA', t: 5, q: 'Which Chicago building, home of the Bulls until 1994, was nicknamed the Madhouse on Madison?', a: 'Chicago Stadium', d: ['The United Center', 'The International Amphitheatre', 'The Rosemont Horizon'] },
  ],
  // day 39
  [
    ...
    { c: 'NBA', t: 5, q: 'Which broadcaster made a plain shouted Yes his signature call on NBA telecasts?', a: 'Marv Albert', d: ['Bob Costas', 'Dick Enberg', 'Mike Breen'] },
  ],
  // day 40
  [
    { c: 'NBA', t: 1, q: 'What replaced the peach baskets used in the earliest basketball games?', a: 'A metal hoop with a net', d: ['A wooden box', 'A rope ring', 'A painted square'] },
    { c: 'NBA', t: 2, q: 'Which club won the first NBA championship after the 1949 merger?', a: 'The Minneapolis Lakers', d: ['The Syracuse Nationals', 'The Rochester Royals', 'The New York Knickerbockers'] },
    { c: 'NBA', t: 3, q: 'Who founded the Boston Celtics in 1946 and owned the club until 1964?', a: 'Walter Brown', d: ['Ned Irish', 'Eddie Gottlieb', 'Lou Pieri'] },
    { c: 'NBA', t: 4, q: 'What change to the court did the NBA make in 1951 in response to dominant big men?', a: 'It doubled the width of the free throw lane', d: ['It raised the rim', 'It moved the baseline back', 'It added a second official'] },
    { c: 'NBA', t: 5, q: 'Which club took the 1951 NBA championship during its years in Rochester?', a: 'The Royals', d: ['The Nationals', 'The Capitols', 'The Stags'] },
  ],
  // day 41
  [
    { c: 'NBA', t: 1, q: 'What is the national college basketball tournament held each spring popularly called?', a: 'March Madness', d: ['The Frozen Four', 'The Bowl Championship Series', 'The College World Series'] },
    { c: 'NBA', t: 2, q: "Which Louisiana university did Shaquille O'Neal attend?", a: 'LSU', d: ['Tulane', 'Georgetown', 'Michigan'] },
    { c: 'NBA', t: 3, q: 'What name was given to the celebrated 1991 freshman class at Michigan?', a: 'The Fab Five', d: ['The Flying Five', 'The Wolverine Wave', 'The Motor City Kids'] },
    { c: 'NBA', t: 4, q: 'Georgetown, Syracuse and Villanova all competed in which college conference in the 1980s?', a: 'The Big East', d: ['The Atlantic Coast Conference', 'The Big Ten', 'The Southeastern Conference'] },
    { c: 'NBA', t: 5, q: 'Which university did Larry Bird attend for less than a month before leaving?', a: 'Indiana', d: ['Purdue', 'Kentucky', 'Louisville'] },
  ],
  // day 42
  [
    { c: 'NBA', t: 1, q: 'What are the five players who begin a game for a club collectively called?', a: 'The starting lineup', d: ['The rotation', 'The depth chart', 'The active list'] },
    { c: 'NBA', t: 2, q: 'Who was named NBA Rookie of the Year for the 1984 to 1985 season?', a: 'Michael Jordan', d: ['Hakeem Olajuwon', 'Sam Bowie', 'Charles Barkley'] },
    { c: 'NBA', t: 3, q: 'Which Atlanta forward won the 1985 Slam Dunk Contest?', a: 'Dominique Wilkins', d: ['Larry Nance', 'Terence Stansbury', 'Julius Erving'] },
    { c: 'NBA', t: 4, q: 'Which Houston center, taken first overall in 1983, formed the Twin Towers with Hakeem Olajuwon?', a: 'Ralph Sampson', d: ['Joe Barry Carroll', 'Bill Cartwright', 'Mark Eaton'] },
    { c: 'NBA', t: 5, q: 'How many home games did the 1985 to 1986 Boston Celtics lose?', a: 'One', d: ['Three', 'Five', 'Zero'] },
  ],
  // day 43
  [
  ...
  [
    ...
    { c: 'NBA', t: 5, q: 'The Indiana Pacers name draws on the state pace car tradition and which style of horse racing?', a: 'Harness racing', d: ['Thoroughbred racing', 'Steeplechase', 'Quarter horse racing'] },
  ],
  // day 45
  [
    ...
    { c: 'NBA', t: 5, q: 'How many clubs took part in the first NBA draft lottery in 1985?', a: 'Seven', d: ['Five', 'Eleven', 'Fourteen'] },
  ],
  // day 46
  [
  ...
  [
    ...
    { c: 'NBA', t: 5, q: 'Which New York guard threw down a famous left handed dunk over Horace Grant in the 1993 Eastern Conference finals?', a: 'John Starks', d: ['Greg Anthony', 'Rolando Blackman', 'Doc Rivers'] },
  ],
  // day 48
  [
    { c: 'NBA', t: 1, q: 'What is the word for a long running competitive feeling between two clubs that meet often in big games?', a: 'A rivalry', d: ['A dynasty', 'A franchise', 'A conference'] },
    { c: 'NBA', t: 2, q: 'Which Lakers guard of the 1960s carried the nickname Mr. Clutch?', a: 'Jerry West', d: ['Elgin Baylor', 'Gail Goodrich', 'Dick Barnett'] },
    { c: 'NBA', t: 3, q: 'How many times did the Celtics and Lakers meet in the Finals during the 1960s?', a: 'Six', d: ['Four', 'Three', 'Eight'] },
    { c: 'NBA', t: 4, q: 'What did Magic Johnson call the running hook that decided Game 4 of the 1987 Finals?', a: 'The junior sky hook', d: ['The baby jumper', 'The rainbow', 'The showtime scoop'] },
    { c: 'NBA', t: 5, q: 'Which coach was on the Boston bench for the 1984 championship over Los Angeles?', a: 'K.C. Jones', d: ['Bill Fitch', 'Tom Heinsohn', 'Chris Ford'] },
  ],
  // day 49
  [
    ...
    { c: 'NBA', t: 5, q: 'Which club did the Dallas Mavericks beat in the 2011 Western Conference finals?', a: 'The Oklahoma City Thunder', d: ['The San Antonio Spurs', 'The Los Angeles Lakers', 'The Denver Nuggets'] },
  ],
  // day 50
  [
    ...
    { c: 'NBA', t: 5, q: 'Which club split its home schedule between Kansas City and Omaha in the early 1970s?', a: 'The Kings', d: ['The Bulls', 'The Bucks', 'The Braves'] },
  ],
  // day 51
  [
    { c: 'NBA', t: 1, q: 'Which country is Dirk Nowitzki from?', a: 'Germany', d: ['Austria', 'Switzerland', 'Denmark'] },
    { c: 'NBA', t: 2, q: 'Which annual honor did Dirk Nowitzki collect in 2007, the first European to do so?', a: 'Most Valuable Player', d: ['Defensive Player of the Year', 'Sixth Man of the Year', 'Most Improved Player'] },
    { c: 'NBA', t: 3, q: 'Which country took the silver medal in mens basketball at the 1992 Olympics?', a: 'Croatia', d: ['Lithuania', 'Brazil', 'Australia'] },
    { c: 'NBA', t: 4, q: 'Who became the first European trained NBA Rookie of the Year, in 2002?', a: 'Pau Gasol', d: ['Andrei Kirilenko', 'Peja Stojakovic', 'Vladimir Radmanovic'] },
    { c: 'NBA', t: 5, q: 'Which player was named Most Valuable Player of the first NBA All-Star Game?', a: 'Ed Macauley', d: ['George Mikan', 'Bob Cousy', 'Dolph Schayes'] },
  ],
  // day 52
  [
    { c: 'NBA', t: 1, q: 'What is the executive responsible for a club roster and trades called?', a: 'The general manager', d: ['The head coach', 'The team captain', 'The equipment manager'] },
    { c: 'NBA', t: 2, q: 'Which former Bulls guard took over as head coach in Golden State in 2014?', a: 'Steve Kerr', d: ['Luke Walton', 'Mark Jackson', 'Alvin Gentry'] },
    { c: 'NBA', t: 3, q: 'Which coach led the Toronto Raptors to the 2019 championship?', a: 'Nick Nurse', d: ['Dwane Casey', 'Sam Mitchell', 'Jay Triano'] },
    { c: 'NBA', t: 4, q: 'How many regular season games did the 1971 to 1972 Lakers win, a record at the time?', a: '69', d: ['66', '72', '68'] },
    { c: 'NBA', t: 5, q: 'Which former Celtics guard was the executive who assembled the Boston roster that won in 2008?', a: 'Danny Ainge', d: ['Red Auerbach', 'Chris Wallace', 'Jan Volk'] },
  ],
  // day 53
  [
  ...
  // day 54
  [
    { c: 'NBA', t: 1, q: 'What does the box score abbreviation PPG stand for?', a: 'Points per game', d: ['Passes per game', 'Plays per game', 'Personal fouls per game'] },
    { c: 'NBA', t: 2, q: 'Which player averaged a triple double across the whole 2016 to 2017 season?', a: 'Russell Westbrook', d: ['James Harden', 'LeBron James', 'Chris Paul'] },
    { c: 'NBA', t: 3, q: 'How many three pointers did Stephen Curry make in the 2015 to 2016 regular season?', a: '402', d: ['286', '372', '415'] },
    { c: 'NBA', t: 4, q: 'Which Utah forward scored 61 points against Milwaukee in January 1990?', a: 'Karl Malone', d: ['John Stockton', 'Jeff Malone', 'Thurl Bailey'] },
    { c: 'NBA', t: 5, q: 'How many assists did Scott Skiles hand out in a December 1990 game?', a: '30', d: ['24', '27', '33'] },
  ],
  // day 55
  [
  ...
  [
    ...
    { c: 'NBA', t: 5, q: 'With what overall pick did San Antonio select Manu Ginobili in 1999?', a: '57th', d: ['28th', '41st', '49th'] },
  ],
];
