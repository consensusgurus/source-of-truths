...
export const PUZZLE_CATEGORIES = [
  ...
  },
  {
    ...
    description: 'Nineteen free daily logic puzzles: a nonogram, slitherlink, shikaku, a shape-fitting puzzle, three sizes of sliding block puzzle, whodunit deduction grids, liar puzzles and more. Every board has exactly one solution reachable by logic. New puzzles at midnight Eastern, no signup.',
    lede: 'Nineteen logic puzzles with one new board apiece every day. Pencil-and-paper classics (a nonogram, a slitherlink loop, shikaku rectangles, a shape-fitting puzzle, a sliding block puzzle in three sizes) alongside deduction puzzles built around suspects, liars, hidden rules and results tables. Every board has exactly one solution and can be reached without a guess.',
    keys: ['etch', 'hedge', 'plot', 'snug', 'park', 'impound', 'junkyard', 'paths', 'jester', 'fib', 'axiom', 'venn', 'stands', 'alibi', 'sworn', 'hearsay', 'docket', 'suffice', 'chomp'],
    generic: {
      etch: 'Nonogram (picross)', hedge: 'Slitherlink', plot: 'Shikaku', snug: 'Shape-fitting (polyomino tiling)', park: 'Sliding block puzzle', impound: 'Sliding block puzzle (larger board)', junkyard: 'Sliding block puzzle (largest board)', paths: 'Network puzzle',
  ...
  // End Game is the whole category, of which /chess-puzzles is the chess third.
  {
    ...
    description: 'Eight free daily endgame puzzles played out against a real engine: mate in two, defend the mate, a king-and-pawn ending, a Go endgame, an Othello ending, a checkers sweep, a won Connect Four position and a dots-and-boxes endgame. One move keeps the win. New positions at midnight Eastern, no signup.',
    lede: 'Eight endgames a day, each one a position you are already winning with one move that keeps it. Three from chess, and one each from Go, Othello, checkers, Connect Four and dots and boxes. None of them is checked against a key: the position is played out against an engine that defends as well as it can, and the round ends when the game does.',
    ...
    generic: {
      ...
      yose: 'Go endgame', turn: 'Othello endgame', check: 'Checkers sweep', four: 'Connect Four endgame', chain: 'Dots and boxes endgame',
    },
    circuit: 'chess-board',
  ...
  },
  {
    ...
    description: 'Five free daily card games with the same deal for everyone: a solitaire with a proven minimum line, a poker solitaire grid, five hands of blackjack off one fixed shoe, a cribbage throw worked out exactly, and a double dummy bridge problem against perfect defenders. New deals at midnight Eastern, no signup.',
    lede: 'Five card games a day, and the deal is the same for everybody, which is what makes a leaderboard possible in games that are usually about luck. A twenty-card solitaire with a perfect line that is the proven minimum, a poker solitaire where every row and column is a hand, five hands of blackjack off one fixed shoe, five cribbage throws valued exactly, and a double dummy bridge problem with all four hands face up.',
    keys: ['taire', 'hands', 'shoe', 'crib', 'finesse'],
    generic: { taire: 'Solitaire', hands: 'Poker solitaire', shoe: 'Blackjack, fixed shoe', crib: 'Cribbage discard', finesse: 'Double dummy bridge' },
    circuit: 'table',
    ...
    how: [
      ...
      'Shoe is five hands of blackjack off one fixed shoe, the same cards in the same order for everyone, with par set by the book line, so counting what you have seen is how you beat it. Crib is the cribbage throw: six cards, two to the crib, and every choice valued over every cut card and every crib. Finesse is a double dummy problem: all four hands face up, one suit trumps, you play South and dummy against two perfect defenders, and the contract names the tricks you need.',
    ],
    startTitle: 'Where to start',
    start: 'Hands if you know poker hands. Shoe if you want to count. Taire if you like a solitaire with an answer. Crib if you have ever played cribbage. Finesse is the deepest of the five and worth a slow first sitting.',
    week: [
