...
export const LOFT_GAMES = new Set([
  ...
  'impound', 'junkyard', 'snug', 'mate', 'mercury', 'niche', 'outrank', 'outwit', 'park', 'paths', 'ping', 'plot',
  ...
  'turn', 'venn', 'warmer', 'atlas', 'sport', 'calc', 'encore', 'biz', 'flank', 'knight', 'script', 'quotes', 'focus', 'thread', 'slot', 'whittle', 'diag', 'frame', 'rim', 'yose', 'crib',
]);
