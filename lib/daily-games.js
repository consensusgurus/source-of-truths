...
const RAW = [
  ...
  { key: 'mate', keepsAnswer: true, miss: 'Tries', name: 'Mate', cat: 'End Game', tag: 'White to play and mate', how: 'Find the one move that forces checkmate, then play the line out against the best defense.', color: '#6b4423', colorNavy: '#d9b38c' },
  ...
  { key: 'snug', miss: null, name: 'Snug', cat: 'Logic', tag: 'Fit the pieces, one way only', how: 'A board with a few squares missing and a handful of pieces that fill it exactly. Tap a piece, turn or flip it, tap the board to drop it. Every board fits together exactly one way, so a full board is always the right board. Weekdays are 6x6, the Sunday Edition is 7x7 with eight pieces.', color: '#3b5bdb', colorNavy: '#91a7ff' },
  ...
  { key: 'hinge', miss: 'Detours', name: 'Hinge', cat: 'Word', tag: 'Chain the compounds', how: 'Six words in a chain, and you get the first and the last. Fill the four between so every pair of neighbors makes a compound word or a phrase everyone knows: fireplace, placemat, board game. Any chain that holds counts; a real word that does not hinge is a detour, and detours break ties on the clock.', color: '#4f46e5', colorNavy: '#a5b4fc' },
  ...
  { key: 'crib', miss: null, name: 'Crib', cat: 'Cards', tag: 'Six cards, throw two', how: 'Five hands of six cards, and for each you throw two to the crib, which alternates between yours and your opponent\'s. Every throw is valued exactly over every cut card and every crib, so the best throw is a fact. Two points for the best, one for a close one.', color: '#a16207', colorNavy: '#fcd34d' },
  ...
  { key: 'chain', keepsAnswer: true, miss: 'Tries', name: 'Chain', cat: 'End Game', tag: 'Take them, or leave them', how: 'The safe edges are gone and the boxes are counted in your favor. One edge keeps it, and the free box is usually the trap.', color: '#4a044e', colorNavy: '#f0abfc' },
  ...
  { key: 'yose', keepsAnswer: true, miss: 'Tries', name: 'Yose', cat: 'End Game', tag: 'The last points on the board', how: 'A Go endgame you are already winning. The walls are built and a handful of open points decide it; White answers perfectly and one first move keeps the win. Pass when nothing is worth playing, and two passes count the board by area.', color: '#44403c', colorNavy: '#d6d3d1' },
  ...
  { key: 'cages', miss: null, name: 'Cages', cat: 'Sudoku', tag: 'The daily killer sudoku', how: 'Killer sudoku: not one digit is printed. The grid is cut into cages labeled with the total of the digits inside them, and those totals are the whole clue set.', color: '#6b21a8', colorNavy: '#cba6f7' },
  ...
  { key: 'queen', keepsAnswer: true, miss: 'Tries', name: 'Queen', cat: 'End Game', tag: 'White to play and promote', how: 'A king and pawn endgame you are already winning. One first move keeps the win, and then every move of the walk has to be exact against a perfect defense.', color: '#a16207', colorNavy: '#f2c14e' },
  ...
  { key: 'polka', miss: null, name: 'Polka', cat: 'Sudoku', tag: 'No numbers, only dots', how: 'Kropki sudoku: not one digit is printed. A white dot means the neighbors differ by 1, a black dot means one is double the other, and no dot means neither, so the silences are clues too.', color: '#16a34a', colorNavy: '#67dd9a' },
