...
export const CFB_TEAMS = {
  'Ohio State':      { id: 194,  aliases: ['Ohio St.'] },
  ...
  'Penn State':      { id: 213,  aliases: ['Penn St.'] },
  ...
  'Auburn':          { id: 2,    aliases: [] },
  'South Carolina':  { id: 2579, aliases: ['S. Carolina'] },
  ...
  'Mississippi State': { id: 344, aliases: ['Miss. St.'] },
  'Kansas State':    { id: 2306, aliases: ['Kansas St.'] },
  'Florida State':   { id: 52,   aliases: ['Florida St.'] },
  'Arizona':         { id: 12,   aliases: [] },
  'Virginia Tech':   { id: 259,  aliases: ['Va. Tech'] },
  'Northwestern':    { id: 77,   aliases: [] },
  'Virginia':        { id: 258,  aliases: [] },
  'Arizona State':   { id: 9,    aliases: ['Arizona St.'] },
  'TCU':             { id: 2628, aliases: ['Texas Christian'] },
  'Georgia Tech':    { id: 59,   aliases: ['Ga. Tech'] },
  'Arkansas':        { id: 8,    aliases: [] },
  'NC State':        { id: 152,  aliases: ['North Carolina State', 'NC St.'] },
  'Baylor':          { id: 239,  aliases: [] },
  'Kansas':          { id: 2305, aliases: [] },
  'Duke':            { id: 150,  aliases: [] },
  'Boise State':     { id: 68,   aliases: ['Boise St.'] },
  'Iowa State':      { id: 66,   aliases: ['Iowa St.'] },
  'Wake Forest':     { id: 154,  aliases: [] },
  'California':      { id: 25,   aliases: ['Cal'] },
  'Tulane':          { id: 2655, aliases: [] },
  'UNLV':            { id: 2439, aliases: ['Nevada-Las Vegas'] },
  'North Carolina':  { id: 153,  aliases: ['N. Carolina'] },
  'Colorado':        { id: 38,   aliases: [] },
  'Cincinnati':      { id: 2132, aliases: [] },
  'Oklahoma State':  { id: 197,  aliases: ['Oklahoma St.'] },
  'UCF':             { id: 2116, aliases: ['Central Florida'] },
  'San Diego State': { id: 21,   aliases: ['San Diego St.'] },
  'Memphis':         { id: 235,  aliases: [] },
  'James Madison':   { id: 256,  aliases: ['JMU'] },
  'Navy':            { id: 2426, aliases: [] },
  'New Mexico':      { id: 167,  aliases: [] },
  'Western Michigan':{ id: 2711, aliases: ['WMU'] },
  'Liberty':         { id: 2335, aliases: [] },
  'Louisiana':       { id: 309,  aliases: ['Louisiana-Lafayette', 'UL Lafayette'] },
  "Hawai'i":         { id: 62,   aliases: ['Hawaii'] },
  'Jacksonville State': { id: 55, aliases: ['J\'ville St.'] },
  ...
  'South Alabama':   { id: 6,    aliases: ['S. Alabama'] },
  'Sacramento State':{ id: 16,   aliases: ['Sacramento St', 'Sac State'] },
  'San José State':  { id: 23,   aliases: ['San Jose State', 'San Jose St'] },
  'Stanford':        { id: 24,   aliases: [] },
  'Colorado State':  { id: 36,   aliases: ['Colorado St.'] },
  'UConn':           { id: 41,   aliases: ['Connecticut'] },
  'Delaware':        { id: 48,   aliases: [] },
  'South Florida':   { id: 58,   aliases: ['USF'] },
  'Western Kentucky':{ id: 98,   aliases: ['WKU'] },
  'Boston College':  { id: 103,  aliases: ['Boston Coll.'] },
  'Massachusetts':   { id: 113,  aliases: ['UMass'] },
  'Maryland':        { id: 120,  aliases: [] },
  'Michigan State':  { id: 127,  aliases: ['Michigan St.'] },
  'East Carolina':   { id: 151,  aliases: ['ECU'] },
  'Rutgers':         { id: 164,  aliases: [] },
  'New Mexico State':{ id: 166,  aliases: ['New Mex. St.'] },
  ...
  'Oregon State':    { id: 204,  aliases: ['Oregon St.'] },
  'Temple':          { id: 218,  aliases: [] },
  'Rice':            { id: 242,  aliases: [] },
  'North Texas':     { id: 249,  aliases: [] },
  'Washington State':{ id: 265,  aliases: ['Wash. St.'] },
  'Marshall':        { id: 276,  aliases: [] },
  'West Virginia':   { id: 277,  aliases: ['W. Virginia'] },
  'Fresno State':    { id: 278,  aliases: ['Fresno St.'] },
  'Georgia Southern':{ id: 290,  aliases: ['Ga. Southern'] },
  'Old Dominion':    { id: 295,  aliases: ['ODU'] },
  'Coastal Carolina':{ id: 324,  aliases: ['Coastal Caro.'] },
  'Texas State':     { id: 326,  aliases: ['Texas St.'] },
  'Utah State':      { id: 328,  aliases: ['Utah St.'] },
  'Kennesaw State':  { id: 338,  aliases: ['Kennesaw'] },
  'Army':            { id: 349,  aliases: [] },
  'Air Force':       { id: 2005, aliases: [] },
  'Akron':           { id: 2006, aliases: [] },
  'App State':       { id: 2026, aliases: ['Appalachian State', 'Appalachian St', 'App. St.'] },
  'Arkansas State':  { id: 2032, aliases: ['Arkansas St.'] },
  'Ball State':      { id: 2050, aliases: ['Ball St.'] },
  'Buffalo':         { id: 2084, aliases: [] },
  'Central Michigan':{ id: 2117, aliases: ['CMU'] },
  'Eastern Michigan':{ id: 2199, aliases: ['EMU'] },
  'Florida Atlantic':{ id: 2226, aliases: ['FAU'] },
  'Florida International': { id: 2229, aliases: ['FIU', 'Florida Intl', 'Fla. International'] },
  'Georgia State':   { id: 2247, aliases: ['Georgia St.'] },
  'Kent State':      { id: 2309, aliases: ['Kent St.'] },
  'Louisiana Tech':  { id: 2348, aliases: ['La. Tech'] },
  ...
  'North Dakota State': { id: 2449, aliases: ['N. Dakota St'] },
  'Northern Illinois': { id: 2459, aliases: ['N. Illinois'] },
  'Purdue':          { id: 2509, aliases: [] },
  'Sam Houston':     { id: 2534, aliases: ['Sam Houston State'] },
  'Southern Miss':   { id: 2572, aliases: ['Southern Mississippi', 'So. Miss'] },
  'Missouri State':  { id: 2623, aliases: ['Missouri St.'] },
