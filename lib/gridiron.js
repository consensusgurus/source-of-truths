...
/*
  ...
  built. The 30-day rule cannot see that. BCF Toys F+ prints "2026 F+ Ratings
  (through Week 1)" in its own heading and updates midweek, so on the 2026-09-14
  build it was six days old, inside every age limit, and still describing a
  board that had not seen a single week-2 result. Scoring it would have mixed a
  week-1 opinion into a week-2 ranking under a header claiming the models carry
  36% of the board.
