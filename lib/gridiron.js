...
/*
  ...
  Second use, 2026-09-15: the NFL win-totals board. It is UNDATED and names the
  season, so §5's undated path passes it, and nothing about its age is wrong.
  What is wrong is that a full week of football was played and its order did not
  move a single place, while its own played-games column still read 0 for the
  team that had won on Monday night. That is the frozen preseason market
  CLAUDE-RANKINGS.md §3 predicted for win totals, and a market pillar is exactly
  where it does the most damage, so it is not scored.
