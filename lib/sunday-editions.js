...
export const SUNDAY_EDITION_GAMES = [
  ...
  'listed', 'mate', 'four', 'park', 'impound', 'junkyard', 'snug', 'check', 'rung', 'hinge', 'sums', 'crunch', 'taire', 'finesse', 'crib', 'fib',
  'babel', 'glyph', 'chain', 'turn', 'yose', 'blocks', 'chomp', 'sweep', 'docket', 'defend',
