...
const GAME_PATHS = [
  ...
  'bracket', 'lode', 'etch', 'glyph', 'hedge', 'listed', 'mate', 'four', 'parker', 'impound', 'junkyard', 'snug', 'check',
  'rung', 'crunch', 'taire', 'fib', 'streak', 'feud', 'babel', 'chain', 'turn', 'yose', 'suffice',
  'docket', 'plot', 'barter', 'sixes', 'niche', 'shoe', 'queen', 'defend', 'blitz', 'blitzed', 'sums', 'hinge', 'strata', 'blocks', 'chomp',
  'sweep', 'redact', 'paths', 'deep', 'anon', 'hands', 'finesse', 'crib', 'atlas', 'sport', 'towers', 'mercury', 'polka',
