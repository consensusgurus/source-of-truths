...
export const GAME_PUZZLES = {
  ...
  listed: P_listed, mate: P_mate, four: P_four, park: P_park, impound: P_impound, junkyard: P_junkyard, snug: P_snug, check: P_check, rung: P_rung,
  crunch: P_crunch, taire: P_taire, fib: P_fib, streak: P_streak, feud: P_feud, babel: P_babel,
  chain: P_chain,
  turn: P_turn,
  glyph: P_glyph, hands: P_hands, finesse: P_finesse, yose: P_yose, crib: P_crib,
  suffice: P_suffice,
  strata: P_strata,
  blocks: P_blocks,
  sweep: P_sweep,
