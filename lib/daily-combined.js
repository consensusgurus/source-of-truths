  ...
  while (i < N) {
    ...
    for (let k = i; k < j; k++) {
      ...
      players.set(uk, {
        ...
        // WHEN THE RUN LANDED, carried straight off the stored row. Nothing
        // scores on it: the home's group feed orders by it, and a board that
        // does not read it is byte-identical to before (2026-09-22).
